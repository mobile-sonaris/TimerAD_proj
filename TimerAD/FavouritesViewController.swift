...
class FavouritesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if currentViewState == true {
            ...
            self.currentViewController = self.storyboard?.instantiateViewControllerWithIdentifier("FavouritesTableViewController")
        }else {
            self.currentViewController = self.storyboard?.instantiateViewControllerWithIdentifier("FavouritesMapViewController")
        }
